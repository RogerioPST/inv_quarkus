...
import rogerio.pst.services.AtivoUsuarioService;


@Path("/api/ativo_usuario")
...
public class AtivoUsuarioResource {

				
	
	@Inject
	AtivoUsuarioService ativoUsuarioService;

	@GET	
	@Operation(summary = "simular um empréstimo")
	public List<AtivoUsuario> list(){
		return ativoUsuarioService.findAll();
	}
