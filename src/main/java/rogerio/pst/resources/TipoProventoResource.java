...
import rogerio.pst.services.TipoProventoService;


@Path("/api/tipo_provento")
...
public class TipoProventoResource {

	@Inject
	TipoProventoService tipoProventoService;
	...
	public List<TipoProvento> list(){
		return tipoProventoService.findAll();
	}
